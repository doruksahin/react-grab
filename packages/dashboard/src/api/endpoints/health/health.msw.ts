...
export const getHealthCheckResponseMock = (overrideResponse: Partial<Extract<HealthCheck200, object>> = {}): HealthCheck200 => ({status: faker.helpers.arrayElement(['ok'] as const), ...overrideResponse})
